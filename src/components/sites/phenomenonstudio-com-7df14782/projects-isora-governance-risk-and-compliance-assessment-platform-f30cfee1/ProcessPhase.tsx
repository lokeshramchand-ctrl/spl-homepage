      ...
      <div className="mx-auto max-w-[1440px] px-4">
        ...
        {stageList && stageList.length > 0 && (
          <div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div className="hidden sm:block" />
            <FadeUp>
              <p className="font-body text-xs font-semibold uppercase tracking-wide text-[#080d10]/50">Stages</p>
              <ul className="font-body mt-3 flex list-disc flex-col gap-1.5 pl-5 text-sm text-[#080d10]/70">
                {stageList.map((s) => (
                  <li key={s}>{s}</li>
                ))}
              </ul>
